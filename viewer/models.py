from django.db.models import Model, CharField, DateField, ForeignKey, SET_NULL, TextField, DateTimeField, \
...
class Creator(Model):
    ...
    def __repr__(self):
        return f"Creator(name={self.name}, surname={self.surname}, artistic_name={self.artistic_name}, country={self.country})"
